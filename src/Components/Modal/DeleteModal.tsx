  ...
  return (
    ...
    >
      <div className='w-full h-full flex items-center justify-center'>
        <div
          className={classNames(
            'delete-modal bg-white min-h-[300px] min-w-[600px] max-w-[600px] transition-all px-8 rounded-lg relative overflow-hidden flex flex-col items-start justify-end',
            {
          ...
          <div className='relative z-10 w-full h-full flex flex-col items-start justify-end pb-5 gap-7'>
            <div className='flex flex-col items-start justify-start gap-1'>
              ...
              <p className='text-base text-slate-950 font-inter'>
                Disabling this organization will immediately revoke its access
                to the OrbitRMS platform. All users will be logged out, and
                active workflows may be interrupted. Use this action
                carefully—it should only be done when necessary. You can
                re-enable access later from the admin panel.
              </p>
            </div>
