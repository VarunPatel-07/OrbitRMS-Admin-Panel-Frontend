...
function Sidebar() {
  ...
  const SidebarMenuItemsArray = SidebarMenuItems('orbitrms');
              ...
              <li
                ...
                className={`w-full group relative rounded-md transition-all ${
                  navigation.pathname.includes(
                    ...
                    ? 'bg-[#ad72ff] text-white'
                    : 'hover:bg-[#ad72ff] text-black hover:text-white'
                }`}
              >
                <Link
                  to={item.link}
                ...
                >
                  ...
                  <span
                    className={`inline-block text-nowrap font-semibold transition-opacity ${
                      collapsed
                        ? 'px-4 opacity-0'
                        : 'px-0 opacity-100 text-base'
                    }`}
                  >
                    {item.name}
                  </span>
