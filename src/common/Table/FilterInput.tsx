...
function FilterInput({
  ...
  const renderOptionsDropdown = () => {
    ...
    const height =
      filteredOptions.length >= 8 ? 320 : filteredOptions.length * 45;
        ...
        >
          ...
          >
            <div className='flex items-start justify-start gap-2'>
              ...
              <div
                className={classNames(
                  'shadow-xl rounded-md overflow-hidden origin-top transition-all border border-black/15 max-h-[320px] overflow-y-auto hide-scrollbar',
                  {
                    'scale-y-0 opacity-0': !showFilterDropDownMenu,
                    'scale-y-100 opacity-100': showFilterDropDownMenu,
                  }
              ...
              <div
                className={classNames(
                  'shadow-xl rounded-md overflow-hidden origin-top transition-all relative border border-black/15 max-h-[320px] overflow-y-auto hide-scrollbar',
                  {
